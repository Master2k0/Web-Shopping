...
(function (h) {
          ...
          (j = l[i]),
            ...
            j && j._bAttrSrc
              ? (R(j.mData._)(d, o),
                ...
                u(j.mData.filter, a))
              : q
              ? (j._setter || (j._setter = R(j.mData)), j._setter(d, o))
              : (d[i] = o);
        i++;
      };
    if (f)
  ...
  function Ja(a, b, c, d) {
    ...
    if (null === e.nTr) {
      ...
      for (q = a.aoColumns.length; l < q; l++) {
        ...
        h.fnCreatedCell &&
          h.fnCreatedCell.call(a.oInstance, i, B(a, b, l), f, b, l);
      }
      ...
      if (0 !== i.length) {
        ...
        for (j = j ? 0 : g; j < f; j++) {
          ...
          if (0 !== e) {
            var u = d[c % e];
            q._sRowStripe != u &&
              (h(l).removeClass(q._sRowStripe).addClass(u),
              (q._sRowStripe = u));
          }
    ...
    for (i = c.length; f < i; f++) {
      ...
      for (e = d.firstChild; e; ) {
        if (
          ...
          for (j = 0; j < l; j++)
            for (g = 0; g < q; g++)
              (a[f + g][o + j] = { cell: e, unique: u }), (a[f + g].nTr = d);
        }
        e = e.nextSibling;
      }
    }
  ...
  function Z(a) {
    ...
    if (a.scrollBarVis !== L && a.scrollBarVis !== k)
      ...
      r &&
        ((P = r.clone().prependTo(p)), (s = r.find('tr')), (P = P.find('tr')));
    ...
    if (d || (!u && !f && !e && j == ca(a) && j == o.length))
      ...
      for (m = e = 0; m < i.length; m++)
        (k = h(o[m])),
          ...
          (k = p.bBounding
            ? Math.ceil(o[m].getBoundingClientRect().width)
            : k.outerWidth()),
          (e += k),
          (c[i[m]].sWidth = w(k - g));
      b.style.width = w(e);
  ...
  function Kb(a) {
    ...
    if (a.oFeatures.bStateSave) {
      ...
      if (
        e &&
        e.time &&
        ((b = v(a, 'aoStateLoadParams', 'stateLoadParams', [a, e])),
        -1 === h.inArray(!1, b) &&
          ((b = a.iStateDuration),
    ...
    this.each(function () {
      ...
      if ('table' != this.nodeName.toLowerCase())
        ...
        e.bJQueryUI
          ? (h.extend(i, m.ext.oJUIClasses, e.oClasses),
            e.sDom === l.sDom &&
              ...
              (n.sDom = '<"H"lfr>t<"F"ip>'),
            n.renderer)
            ? h.isPlainObject(n.renderer) &&
              !n.renderer.header &&
              (n.renderer.header = 'jqueryui')
            : (n.renderer = 'jqueryui')
          : h.extend(i, m.ext.classes, e.oClasses);
        q.addClass(i.sTable);
        n.iInitDisplayStart === k &&
          ((n.iInitDisplayStart = e.iDisplayStart),
        ...
        null === e.asStripeClasses &&
          (n.asStripeClasses = [i.sStripeOdd, i.sStripeEven]);
        ...
        if ('table' === b) (f = c.call(n, l[g], g)), f !== k && e.push(f);
          ...
          for (o = p.length; i < o; i++)
            (f = p[i]),
              (f =
                'cell' === b
                  ? c.call(n, l[g], f.row, f.column, g, i)
                  : c.call(n, l[g], f, g, i, m)),
              f !== k && e.push(f);
        }
      }
      return e.length || d
            ...
            if (a === null || a === k || c) {
              ...
              for (t = g.length; p < t; p++) {
                ...
                for (r = 0; r < m; r++) {
                  ...
                  if (c) {
                    v = f[l];
                    a(s, B(b, l, r), v.anCells ? v.anCells[r] : null) &&
                      o.push(s);
                  } else o.push(s);
                }
              }
