...
(function (e) {
  ...
  var j = e.fn.dataTable,
    ...
    g = function (c, b) {
      ...
      this.c = e.extend(!0, {}, j.defaults.autoFill, g.defaults, b);
      this.s = {
        dt: new j.Api(c),
  ...
  e.extend(g.prototype, {
              ...
              .append(
                e('<div class="dt-autofill-button">').append(
                  e(
                    ...
                    var f = d[l].execute(a, c, e(this).closest('li'));
                    b._update(f, c);
    ...
    _drawSelection: function (c) {
      ...
      if (
        ...
        if ((f = this.dom.dtScroll))
          (b += f.scrollTop()), (c += f.scrollLeft());
        f = this.dom.select;
    ...
    _editor: function (c) {
      ...
      if (a) {
        for (
          var d = {}, f = [], e = a.fields(), h = 0, i = c.length;
          h < i;
          h++
        )
          for (var g = 0, k = c[h].length; g < k; g++) {
            var n = c[h][g],
              j = b.settings()[0].aoColumns[n.index.column],
              m = j.editField;
            if (m === r)
      ...
      var c = this,
        ...
        d =
          null !== this.c.focus
            ...
            : 'hover';
      if ('focus' === d)
        b.on('key-focus.autoFill', function (a, b, d) {
          c._attach(d.node());
    ...
    _shiftScroll: function (c) {
      ...
      null !== a.dtTop && c.pageY < a.dtTop + 65
        ? (j = -5)
        : null !== a.dtTop && c.pageY > a.dtTop + a.dtHeight - 65 && (j = 5);
      null !== a.dtLeft && c.pageX < a.dtLeft + 65
        ? (k = -5)
        : null !== a.dtLeft && c.pageX > a.dtLeft + a.dtWidth - 65 && (k = 5);
      h || g || j || k
        ? ((a.windowVert = h),
          (a.windowHoriz = g),
          (a.dtVert = j),
      ...
      if (!1 !== c) {
        ...
        if (null !== this.c.update ? this.c.update : !this.c.editor) {
          for (var f = 0, e = b.length; f < e; f++)
            for (var h = 0, g = b[f].length; h < g; h++)
              (d = b[f][h]), d.cell.data(d.set);
          a.draw(!1);
        }
    ...
    increment: {
      ...
      execute: function (c, b, a) {
        for (
          ...
          for (var l = 0, h = b[d].length; l < h; l++)
            (b[d][l].set = c), (c += a);
      },
    },
    fill: {
      ...
      option: function (c, b) {
        return c.i18n(
          'autoFill.fill',
          'Fill all cells with <i>' + b[0][0].data + '</i>',
        );
      },
      execute: function (c, b) {
        for (var a = b[0][0].data, d = 0, f = b.length; d < f; d++)
          for (var e = 0, h = b[d].length; e < h; e++) b[d][e].set = a;
      },
    },
    fillHorizontal: {
      available: function (c, b) {
      ...
      execute: function (c, b) {
        for (var a = 0, d = b.length; a < d; a++)
          for (var f = 0, e = b[a].length; f < e; f++)
            b[a][f].set = b[a][0].data;
      },
    },
    fillVertical: {
      available: function (c, b) {
      ...
      execute: function (c, b) {
        for (var a = 0, d = b.length; a < d; a++)
          for (var e = 0, g = b[a].length; e < g; e++)
