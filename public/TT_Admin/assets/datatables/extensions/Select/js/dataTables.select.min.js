...
(function (e) {
  ...
  function t(c) {
    ...
    a.on('mousedown.dtSelect', d, function (b) {
      ...
      .on('click.dtSelect', d, function (b) {
        var d = c.select.items(),
          f = c.settings()[0];
        if (e(b.target).closest('tbody')[0] == a[0]) {
          var p = e(b.target).closest('td, th'),
            g = c.cell(p).index();
          c.cell(p).any() &&
            ('row' === d
              ? ((d = g.row), s(b, c, f, 'row', d))
              : 'column' === d
              ? ((d = c.cell(p).index().column), s(b, c, f, 'column', d))
              : 'cell' === d &&
                ((d = c.cell(p).index()), s(b, c, f, 'cell', d)),
            (f._select_lastCell = g));
        }
      });
    e('body').on('click.dtSelect', function (a) {
      b._select.blurable &&
        !e(a.target).parents().filter(c.table().container()).length &&
        (e(a.target).parents('div.DTE').length || n(b, !0));
    });
  }
  function k(c, a, b, d) {
    if (!d || c.flatten().length)
      b.unshift(c), e(c.table().node()).triggerHandler(a + '.dt', b);
  }
  function u(c) {
    var a = c.settings()[0];
  ...
  function s(c, a, b, d, h) {
    var r = a.select.style(),
      f = a[d](h, { selected: !0 }).any();
    'os' === r
      ? c.ctrlKey || c.metaKey
        ? a[d](h).select(!f)
        : c.shiftKey
        ? 'cell' === d
          ? ((d = b._select_lastCell || null),
            (f = function (b, d) {
              if (b > d)
                var c = d,
                  d = b,
            ...
            !a.cells({ selected: !0 }).any() && !d
              ? ((f = f(0, h.column)), (d = c(0, h.row)))
              : ((f = f(d.column, h.column)), (d = c(d.row, h.row))),
            (d = a.cells(d, f).flatten()),
            a.cells(h, { selected: !0 }).any()
              ? a.cells(d).deselect()
              : a.cells(d).select())
          : ((c = b._select_lastCell ? b._select_lastCell[d] : null),
            (f = a[d + 's']({ search: 'applied' }).indexes()),
            (c = e.inArray(c, f)),
            (b = e.inArray(h, f)),
            !a[d + 's']({ selected: !0 }).any() && -1 === c
              ? f.splice(e.inArray(h, f) + 1, f.length)
              : (c > b && ((r = b), (b = c), (c = r)),
                f.splice(b + 1, f.length),
                f.splice(0, c)),
            a[d](h, { selected: !0 }).any())
          ? (f.splice(e.inArray(h, f), 1), a[d + 's'](f).deselect())
          : a[d + 's'](f).select()
        : ((c = a[d + 's']({ selected: !0 })),
          f && 1 === c.flatten().length
            ? a[d](h).deselect()
            : (c.deselect(), a[d](h).select()))
      : a[d](h).select(!f);
  }
  function o(c, a) {
    return function (b) {
    ...
    function (c, a) {
      g.ext.selector[a.type].push(function (b, d, c) {
        ...
        for (var g = 0, i = c.length; g < i; g++)
          (e = b[a.prop][c[g]]),
            ((!0 === d && !0 === e._select_selected) ||
              (!1 === d && !e._select_selected)) &&
              f.push(c[g]);
        return f;
      });
    },
  ...
  var i = g.Api.register,
    m = g.Api.registerPlural;
  i('select()', function () {});
              ...
              fn: function (b, d, c) {
                ...
                for (c = a.aoColumns.length; b < c; b++)
                  (a.aoColumns[b]._select_selected ||
                    ...
                    e(d.anCells[b]).addClass(a._select.className);
              },
  ...
  m('columns().select()', 'column().select()', function (c) {
    var a = this;
    if (!1 === c) return this.deselect();
  ...
  m('cells().select()', 'cell().select()', function (c) {
    var a = this;
    if (!1 === c) return this.deselect();
    this.iterator('cell', function (a, d, c) {
      n(a);
      d = a.aoData[d];
  ...
  m('cells().deselect()', 'cell().deselect()', function () {
    ...
    this.iterator('cell', function (a, b, c) {
      ...
      b.anCells &&
        ...
        e(b.anCells[c]).removeClass(a._select.className);
    });
    this.iterator('table', function (a, b) {
  ...
  e.extend(g.ext.buttons, {
    ...
    selectedSingle: {
      ...
      init: function (c) {
        ...
        c.on('draw.dt.DT select.dt.DT deselect.dt.DT', function () {
          var b =
            c.rows({ selected: !0 }).flatten().length +
            c.columns({ selected: !0 }).flatten().length +
            c.cells({ selected: !0 }).flatten().length;
          a.enable(1 === b);
        });
        this.disable();
      },
  ...
  e(l).on('preInit.dt.dtSelect', function (c, a) {
    if ('dt' === c.namespace) {
      var b = a.oInit.select || g.defaults.select,
        d = new g.Api(a),
        h = 'row',
        i = 'api',
        f = !1,
      ...
      a._select = {};
      if (!0 === b) i = 'os';
      else if ('string' === typeof b) i = b;
      else if (
        e.isPlainObject(b) &&
        (b.blurable !== j && (f = b.blurable),
        b.info !== j && (k = b.info),
        b.items !== j && (h = b.items),
        b.style !== j && (i = b.style),
        b.selector !== j && (l = b.selector),
        b.className !== j)
      )
        m = b.className;
      d.select.selector(l);
