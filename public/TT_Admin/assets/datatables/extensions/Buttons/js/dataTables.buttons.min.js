...
(function (e) {
  ...
  e.extend(l.prototype, {
    ...
    removeCommit: function () {
      ...
      for (c = a.length - 1; 0 <= c; c--)
        null === a[c] &&
          (a.splice(c, 1), b.splice(c, 1), this.c.buttons.splice(c, 1));
      c = 0;
      for (a = b.length; c < a; c++)
        for (d = b[c].length - 1; 0 <= d; d--)
          null === b[c][d] &&
            (b[c].splice(d, 1), this.c.buttons[c].buttons.splice(d, 1));
      return this;
    },
          ...
          if (e.isArray(h)) this._buildButtons(h, b, c);
            ...
            if (i) {
              ...
              h.buttons &&
                ...
                (h._collection = e('<' + i.tag + '/>').addClass(i.className)),
                this._buildButtons(h.buttons, h._collection, f));
  ...
  l.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      f = function (a) {
        if (e.isArray(a)) for (var h = 0, i = a.length; h < i; h++) f(a[h]);
        else
          'string' === typeof a
            ? -1 !== a.indexOf(',')
              ? f(a.split(','))
    ...
    for (
      var c = [],
        d = function (a, b) {
          ...
          if (e.isArray(a) || a instanceof e) {
          ...
          } else if ('number' === typeof a) c.push({ inst: b, idx: a });
            ...
            'object' === typeof a &&
              a.nodeName &&
              ((g = e.inArray(a, f)),
              -1 !== g && c.push({ inst: b, idx: b.toIndex(f[g]) }));
        },
        f = 0,
        g = a.length;
      f < g;
