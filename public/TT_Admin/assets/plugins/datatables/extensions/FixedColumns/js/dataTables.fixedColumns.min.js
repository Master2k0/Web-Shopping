  ...
  d.extend(m.prototype, {
      ...
      if (
        ...
        g.on('draw.dt.DTFC', function () {
          ...
          .on('destroy.dt.DTFC', function () {
            ...
            d(o).off('resize.DTFC');
            d(b.dom.grid.left.liner).off(
              'mouseover.DTFC touchstart.DTFC scroll.DTFC ' + e,
            );
            d(b.dom.grid.left.wrapper).remove();
            d(b.dom.grid.right.liner).off(
              'mouseover.DTFC touchstart.DTFC scroll.DTFC ' + e,
            );
    ...
    _fnGridLayout: function () {
      var a = this.dom.grid,
        ...
        i = function (a, b) {
          f.bar
            ? (a.style.width = b + f.bar + 'px')
            : ((a.style.width = b + 20 + 'px'),
      ...
      0 < this.s.iLeftColumns &&
        ((a.left.wrapper.style.width = g + 'px'),
        (a.left.wrapper.style.height = '1px'),
        (a.left.body.style.height = c + 'px'),
        a.left.foot && (a.left.foot.style.top = (f.x ? f.bar : 0) + 'px'),
        i(a.left.liner, g),
        (a.left.liner.style.height = c + 'px'));
      0 < this.s.iRightColumns &&
        ((b -= h),
        f.y && (b -= f.bar),
        (a.right.wrapper.style.width = h + 'px'),
        (a.right.wrapper.style.left = b + 'px'),
        (a.right.wrapper.style.height = '1px'),
        (a.right.body.style.height = c + 'px'),
        a.right.foot && (a.right.foot.style.top = (f.x ? f.bar : 0) + 'px'),
        i(a.right.liner, h),
        (a.right.liner.style.height = c + 'px'),
        (a.right.headBlock.style.display = f.y ? 'block' : 'none'),
        (a.right.footBlock.style.display = f.y ? 'block' : 'none'));
    },
    ...
    _fnCopyLayout: function (a, b, c) {
      for (var e = [], f = [], g = [], h = 0, i = a.length; h < i; h++) {
        ...
        for (var l = 0, q = this.s.iTableColumns; l < q; l++)
          if (-1 !== d.inArray(l, b)) {
            ...
            -1 === p
              ? ((p = d(a[h][l].cell).clone(c, !1)[0]),
                f.push(p),
                g.push(a[h][l].cell),
                k.push({ cell: p, unique: a[h][l].unique }))
    ...
    _fnClone: function (a, b, c, e) {
      ...
      if (0 < j.aiDisplay.length) {
        ...
        for (p = 0; p < c.length; p++)
          (l = c[p]),
            (q = d(j.aoColumns[l].nTh).clone(!0)[0]),
            (q.innerHTML = ''),
            (k = q.style),
            (k.paddingTop = '0'),
            (k.paddingBottom = '0'),
