...
(function (f) {
  'function' === typeof define && define.amd
    ...
    ? (module.exports = function (n, i) {
        n || (n = window);
        if (!i || !i.fn.dataTable) i = require('datatables.net')(n, i).$;
        return f(i, n, n.document);
      })
  ...
  function q(a, b, d) {
    for (var e = [], c = 0, f = a.childNodes.length; c < f; c++)
      1 == a.childNodes[c].nodeType && e.push(a.childNodes[c]);
    b = e[b];
    null !== d ? a.insertBefore(b, e[d]) : a.appendChild(b);
  }
  var s = f.fn.dataTable;
  f.fn.dataTableExt.oApi.fnColReorder = function (a, b, d, e) {
    var c,
      g,
      l,
      h,
    ...
    if (b != d)
      if (0 > b || b >= i)
        ...
        for (g = i; c < g; c++) {
          k = a.aoColumns[c];
          l = 0;
          for (h = k.aDataSort.length; l < h; l++)
            k.aDataSort[l] = m[k.aDataSort[l]];
          k.idx = m[k.idx];
        }
        f.each(a.aLastSort, function (c, b) {
          a.aLastSort[c].src = m[b.src];
        });
        c = 0;
        for (g = i; c < g; c++)
          (k = a.aoColumns[c]),
            'number' == typeof k.mData
              ? ((k.mData = m[k.mData]), a.oApi._fnColumnOptions(a, c, {}))
        ...
        if (a.aoColumns[b].bVisible) {
          ...
          h = null;
          for (c = d < b ? d : d + 1; null === h && c < i; )
            (h = this.oApi._fnColumnIndexToVisible(a, c)), c++;
          j = a.nTHead.getElementsByTagName('tr');
          c = 0;
          for (g = j.length; c < g; c++) q(j[c], l, h);
          if (null !== a.nTFoot) {
          ...
          for (g = a.aoData.length; c < g; c++)
            null !== a.aoData[c].nTr && q(a.aoData[c].nTr, l, h);
        }
        o(a.aoColumns, b, d);
        o(a.aoPreSearchCols, b, d);
        c = 0;
        for (g = a.aoData.length; c < g; c++)
          (j = a.aoData[c]),
            j.anCells && o(j.anCells, b, d),
            'dom' !== j.src && f.isArray(j._aData) && o(j._aData, b, d);
        c = 0;
        for (g = a.aoHeader.length; c < g; c++) o(a.aoHeader[c], b, d);
        if (null !== a.aoFooter) {
          c = 0;
          for (g = a.aoFooter.length; c < g; c++) o(a.aoFooter[c], b, d);
        }
  ...
  var h = function (a, b) {
    ...
    e && (e(h.defaults, h.defaults, !0), e(h.defaults, b || {}));
    this.s = {
      dt: null,
      init: f.extend(!0, {}, h.defaults, b),
      fixed: 0,
      fixedRight: 0,
  ...
  f.extend(h.prototype, {
    ...
    fnOrder: function (a, b) {
      ...
      if (a === r) {
        e = 0;
        for (c = g.length; e < c; e++) d.push(g[e]._ColReorder_iOrigCol);
        return d;
      }
      if (b) {
        g = this.fnOrder();
        e = 0;
        for (c = a.length; e < c; e++) d.push(f.inArray(a[e], g));
        a = d;
      }
    ...
    _fnConstruct: function () {
      ...
      var c = null;
      this.s.init.aiOrder && (c = this.s.init.aiOrder.slice());
      ...
      if (c)
        if (a.s.dt._bInitComplete) (b = p(c)), a._fnOrderColumns.call(a, b);
        else {
          var g = !1;
    ...
    _fnOrderColumns: function (a) {
      ...
      if (a.length != this.s.dt.aoColumns.length)
        ...
        for (var d = 0, e = a.length; d < e; d++) {
          var c = f.inArray(d, a);
          d != c &&
            (o(a, c, d), this.s.dt.oInstance.fnColReorder(c, d, !0), (b = !0));
        }
    ...
    _fnStateSave: function (a) {
      ...
      if (a.aaSorting) {
        ...
        for (d = c.length; b < d; b++)
          (e = c[b]._ColReorder_iOrigCol),
            (a.aoSearchCols[e] = g[b]),
            (a.abVisCols[e] = c[b].bVisible),
            a.ColReorder.push(e);
      } else if (a.order) {
    ...
    _fnMouseDown: function (a, b) {
      var d = this,
        ...
        c = parseInt(f(b).attr('data-column-index'), 10);
      c !== r &&
        ...
        (this.s.mouse.target = this.s.dt.aoColumns[c].nTh),
        (this.s.mouse.targetIndex = c),
        (this.s.mouse.fromIndex = c),
        this._fnRegions(),
        f(i)
    ...
    _fnMouseUp: function () {
      f(i).off('mousemove.ColReorder mouseup.ColReorder');
      null !== this.dom.drag &&
    ...
    _fnRegions: function () {
      ...
      for (
        var b = 0, d = f(a[0].nTh).offset().left, e = 0, c = a.length;
        e < c;
        e++
      )
    ...
    _fnCreateDragNode: function () {
      var a = '' !== this.s.dt.oScroll.sX || '' !== this.s.dt.oScroll.sY,
        ...
        c = e.parentNode,
        g = f(b).clone();
      this.dom.drag = f(c.cloneNode(!1))
        .addClass('DTCR_clonedTable')
        .append(f(e.cloneNode(!1)).append(f(d.cloneNode(!1)).append(g[0])))
        .css({
          position: 'absolute',
          top: 0,
          left: 0,
    ...
    ? f.fn.dataTableExt.aoFeatures.push({
        fnInit: function (a) {
          ...
          a._colReorder
            ...
            : ((b = a.oInit), new h(a, b.colReorder || b.oColReorder || {}));
          return null;
        },
        cFeature: 'R',
        sFeature: 'ColReorder',
  ...
  f(i).on('preInit.dt.colReorder', function (a, b) {
    if ('dt' === a.namespace) {
      var d = b.oInit.colReorder,
        e = s.defaults.colReorder;
      if (d || e) (e = f.extend({}, d, e)), !1 !== d && new h(b, e);
    }
  });
