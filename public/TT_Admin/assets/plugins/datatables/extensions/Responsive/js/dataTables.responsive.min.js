  ...
  var l = function (e, i) {
    var h = function (d, a) {
      ...
      this.s.dt.settings()[0].responsive ||
        ...
        (this.c = e.extend(!0, {}, h.defaults, i.defaults.responsive, a)),
        (d.responsive = this),
        this._constructor());
    };
    h.prototype = {
      ...
      _columnsVisiblity: function (d) {
        ...
        for (f = g.length; b < f; b++)
          c[b].control
            ? (a -= c[b].minWidth)
            : '-' === g[b] &&
              ((g[b] = 0 > a - c[b].minWidth ? !1 : !0), (a -= c[b].minWidth));
        a = !1;
        b = 0;
      ...
      _classLogic: function () {
        ...
        c.each(function (b, c) {
          for (
            var d = b.className.split(' '), j = !1, h = 0, l = d.length;
            h < l;
            h++
          ) {
            var i = e.trim(d[h]);
            ...
            e.each(a, function (a, b) {
              var e = b.name.split('-'),
                d = i.match(
                  RegExp(
                    '(min\\-|max\\-|not\\-)?(' + e[0] + ')(\\-[_a-zA-Z0-9])?',
                  ),
                );
              d &&
                ((j = !0),
                d[2] === e[0] && d[3] === '-' + e[1]
                  ? f(c, b.name, d[1], d[2] + d[3])
                  : d[2] === e[0] && !d[3] && f(c, b.name, d[1], d[2]));
            });
          }
          j || (b.auto = !0);
        });
      ...
      _detailsVis: function () {
        ...
        if (0 === c.length || (1 === c.length && this.s.columns[c[0]].control))
          b = !1;
        b
          ? (e(a.table().node()).addClass('collapsed'),
            a
              .rows()
              .eq(0)
              .each(function (b) {
          ...
          : (e(a.table().node()).removeClass('collapsed'),
            a
              .rows()
              .eq(0)
              .each(function (b) {
      ...
      _resizeAuto: function () {
        ...
        if (
          ...
          var c = d.table().node().cloneNode(!1),
            ...
            f = e(d.table().body().cloneNode(!1)).appendTo(c);
          d.rows({ page: 'current' })
            .indexes()
            .flatten()
            .each(function (a) {
        ...
        renderer: function (d, a) {
          var c = d
            ...
            .map(function (a) {
              ...
              var g = d.settings()[0],
                g = g.oApi._fnGetCellData(g, a.row, a.column, 'display');
              return (
                '<li data-dtr-index="' +
                a.column +
