  ...
  CMPLTADMIN_SETTINGS.dbSparklineChart = function () {
    if ($.isFunction($.fn.sparkline)) {
      $('.db_dynamicbar').sparkline(
        [
          8.4, 9, 8.8, 8, 9.5, 8.8, 8, 9.5, 9.2, 9.9, 9, 9, 8.4, 9, 8.8, 8, 9.5,
          9.2, 9.9, 9, 9, 8, 7, 9, 9, 9.5, 8, 9.5, 9.8,
        ],
        {
          type: 'bar',
          barColor: '#3F51B5',
      ...
      $('.db_linesparkline').sparkline(
        [
          2000, 3454, 5454, 2323, 3432, 2323, 3432, 4656, 2897, 3545, 4232,
          5434, 4656, 4656, 2897, 3545, 4232, 5434, 4656, 2323, 3432, 4656,
          2897, 3545, 4232, 5434, 4656, 3567, 4878, 3676, 3787,
        ],
        {
          type: 'line',
          width: '100%',
      ...
      $('.db_linesparkline2').sparkline(
        [
          3545, 4232, 5434, 4656, 4656, 2897, 3545, 4232, 5434, 2000, 3454,
          5454, 2323, 3432, 2323, 3432, 4656, 2897, 4656, 2323, 3432, 4656,
          2897, 3545, 4232, 5434, 4656, 3567, 4878, 3676, 3787,
        ],
        {
          type: 'line',
      ...
      $('.db_compositebar').sparkline(
        [
          4, 6, 7, 7, 4, 3, 2, 4, 6, 7, 4, 6, 7, 7, 4, 3, 2, 4, 6, 7, 7, 4, 3,
          1, 4, 6, 5, 9,
        ],
        {
          type: 'bar',
      ...
      $('.db_compositebar').sparkline(
        [
          4, 1, 5, 7, 9, 9, 8, 8, 4, 7, 9, 4, 6, 7, 7, 4, 3, 2, 4, 6, 7, 9, 8,
          8, 4, 2, 5, 6, 7,
        ],
        {
          composite: true,
  ...
  CMPLTADMIN_SETTINGS.dbRickshawChart = function () {
    ...
    function addAnnotation(force) {
      if (messages.length > 0 && (force || Math.random() >= 0.95)) {
        annotator.add(
          seriesData[2][seriesData[2].length - 1].x,
          messages.shift(),
        );
        annotator.update();
      }
  ...
  CMPLTADMIN_SETTINGS.dbGaugemeter = function () {
    if ($('#gauge-meter').length) {
      var opts = {
        ...
        pointer: {
          length: 0.4, // The radius of the inner circle
