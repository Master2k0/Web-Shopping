...
jQuery(function ($) {
    ...
    $('.page-chatapi .user-row').on('click', function () {
      ...
      if ($(this).hasClass('active')) {
        ...
        if ($('.chatapi-windows #user-window' + id).length) {
          ...
          html +=
            "<div class='typearea'><input type='text' data-user-id='" +
            id +
  ...
  CMPLTADMIN_SETTINGS.mainmenuCollapsed = function () {
    if (
      $('.page-sidebar.chat_shift #main-menu-wrapper').length > 0 ||
  ...
  CMPLTADMIN_SETTINGS.mainMenu = function () {
    ...
    $('body').click(function (e) {
      $('.page-sidebar.collapseit .wraplist li.open .sub-menu').attr(
        'style',
        '',
      );
      $('.page-sidebar.collapseit .wraplist li.open').removeClass('open');
      $('.page-sidebar.chat_shift .wraplist li.open .sub-menu').attr(
        'style',
        '',
      );
        ...
        $('#jstree_treedata').jstree({
          core: {
            ...
            data: {
              url: function (node) {
                return node.id === '#'
                  ? 'data/ajax_demo_roots_jstree.json'
  ...
  CMPLTADMIN_SETTINGS.dataTablesInit = function () {
    if ($.isFunction($.fn.dataTable)) {
      ...
      $(document).ready(function () {
        ...
        $('#example_wrapper .dataTables_filter input').addClass(
          'input-medium ',
        ); // modify table search input
        $('#example_wrapper .dataTables_length select').addClass(
          'select2-wrapper',
        ...
        $('#example2_wrapper .dataTables_filter input').addClass(
          'input-medium ',
        );
        $('#example2_wrapper .dataTables_length select').addClass(
          'select2-wrapper',
        );
      ...
      var i = 1,
        ...
        example_dropzone = $('#customDZ').dropzone({
          ...
          addedfile: function (file) {
            ...
            size =
              size < 1024 ? size + ' KB' : parseInt(size / 1024, 10) + ' MB';
    ...
    if ($.isFunction($.fn.slider)) {
      $('.slider').each(function (i, el) {
        var $this = $(el),
          ...
          orientation =
            getValue($this, 'vertical', 0) != 0 ? 'vertical' : 'horizontal',
    ...
    if ($.isFunction($.fn.typeahead)) {
      ...
      $('#typeahead-4')
        .typeahead(null, {
          ...
          templates: {
            ...
            suggestion: Handlebars.compile(
              '<div class="clearfix" style="width:100%;display:inline-block;min-height:60px;height:auto;"><img src="data/{{cover}}" class="img-responsive pull-left" width="30" style="margin-right:10px;" /><strong>{{value}}</strong> &mdash; {{year}}<br /><span style="display:inline-block; height: 22px; overflow: hidden; white-space:nowrap; text-overflow:ellipsis; max-width: 400px;"></span></div>',
            ),
          },
        })
        .bind('typeahead:opened', function () {
          $(this)
            .data('ttTypeahead')
            .dropdown.$menu.addClass('overflow-hidden')
            .perfectScrollbar();
        })
        .on('keyup', function () {
  ...
  CMPLTADMIN_SETTINGS.widgetSparklineChart = function () {
    if ($.isFunction($.fn.sparkline)) {
      $('.wid_dynamicbar').sparkline(
        [
          8.4, 9, 8.8, 8, 9.5, 9.2, 9.9, 9, 9, 8, 7, 8, 9, 8, 7, 9, 9, 9.5, 8,
          9.5, 9.8,
        ],
        {
          type: 'bar',
      ...
      $('.wid_linesparkline').sparkline(
        [
          2000, 3454, 5454, 2323, 3432, 4656, 2897, 3545, 4232, 4656, 2897,
          3545, 4232, 5434, 4656, 3567, 4878, 3676, 3787,
        ],
        {
          type: 'line',
          width: '100%',
      ...
      $('.wid_compositebar').sparkline(
        [4, 6, 7, 7, 4, 3, 2, 4, 6, 7, 7, 8, 8, 4, 4, 3, 1, 4, 6, 5, 9],
        {
          type: 'bar',
          barColor: '#f5f5f5',
          height: '60',
      ...
      $('.wid_compositebar').sparkline(
        [4, 1, 5, 7, 9, 9, 8, 8, 4, 7, 8, 4, 7, 9, 9, 8, 8, 4, 2, 5, 6, 7],
        {
          composite: true,
