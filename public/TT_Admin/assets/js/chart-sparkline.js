...
jQuery(function ($) {
  ...
  CMPLTADMIN_SETTINGS.chartSparkline = function () {
    if ($.isFunction($.fn.sparkline)) {
      ...
      $('.negativebar').sparkline(
        [
          8, 4, 3, 0, -2, -6, -3, 3, -2, 4, 3, 0, -2, -6, -3, 3, -2, 4, 6, -4,
          4,
        ],
        {
          type: 'bar',
      ...
      $('#compositebar').sparkline(
        [4, 6, 7, 7, 4, 3, 2, 4, 6, 7, 7, 4, 3, 2, 3, 1, 4, 6, 5, 9],
        {
          type: 'bar',
          barColor: '#3F51B5',
          height: '200',
      ...
      $('#compositebar').sparkline(
        [4, 1, 5, 7, 9, 9, 8, 4, 6, 7, 7, 4, 3, 2, 8, 4, 2, 5, 6, 7],
        {
          composite: true,
      ...
      $('#compositeline').sparkline(
        [8, 4, 1, 2, 6, 7, 1, 6, 2, 4, 3, 5, 6, 0, 3, 0, 4, 6, 5, 7, 6],
        {
          fillColor: false,
          changeRangeMin: 0,
          chartRangeMax: 10,
      ...
      $('#compositeline').sparkline(
        [4, 1, 5, 4, 6, 7, 3, 5, 6, 6, 4, 2, 6, 4, 3, 2, 2, 5, 6, 3],
        {
          composite: true,
          fillColor: false,
          changeRangeMin: 0,
      ...
      $('#normalline').sparkline(
        [5, 4, 0, 0, 0, 0, 1, 4, 4, 10, 10, 10, 10, 0, 0, 0, 4, 6, 5, 9, 10],
        {
          fillColor: false,
          normalRangeMin: -1,
          normalRangeMax: 8,
      ...
      $('.discrete1').sparkline(
        [
          4, 6, 7, 7, 4, 3, 2, 1, 4, 4, 5, 6, 7, 6, 6, 2, 4, 5, 4, 4, 5, 6, 7,
          6, 6, 2, 4, 5, 2, 1, 4, 4,
        ],
        {
          type: 'discrete',
