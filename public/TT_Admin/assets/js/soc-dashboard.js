  ...
  CMPLTADMIN_SETTINGS.dbSparklineChart = function () {
    if ($.isFunction($.fn.sparkline)) {
      $('.db_dynamicbar').sparkline(
        [
          8.4, 9, 8.4, 9, 8.8, 8, 9.5, 9.2, 9.9, 9, 9, 8, 7, 9, 9, 9.5, 8, 9.5,
          9.8,
        ],
        {
          type: 'bar',
      ...
      $('.db_linesparkline').sparkline(
        [
          2000, 4656, 2897, 3545, 4232, 5434, 4656, 2323, 3432, 4656, 2897,
      ...
      $('.db_linesparkline2').sparkline(
        [
          3545, 4232, 5434, 4656, 4656, 2323, 3432, 4656, 2897, 3545, 4232,
          5434, 4656, 3567, 4878, 3676, 3787,
        ],
        {
          type: 'line',
          width: '100%',
      ...
      $('.db_compositebar').sparkline(
        [4, 6, 4, 6, 7, 7, 4, 3, 2, 4, 6, 7, 7, 4, 3, 1, 4, 6, 5, 9],
        {
          type: 'bar',
          barColor: '#673AB7',
          height: '80',
