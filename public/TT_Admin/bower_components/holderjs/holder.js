...
!(function (e, t, r) {
  ...
  document.getElementsByClassName ||
    (document.getElementsByClassName = function (e) {
      return (
        (e = String(e).replace(/^|\s+/g, '.')), document.querySelectorAll(e)
      );
    }),
  Object.keys ||
  ...
  (function () {
    function e(t, r, n) {
      t.document;
      var i,
        o = t.currentStyle[r].match(/([\d\.]+)(%|cm|em|in|mm|pc|pt|)/) || [
          0,
          0,
          '',
        ],
      ...
      for (n in o)
        if (
          (Array.prototype.push.call(
            i,
            'styleFloat' == n ? 'float' : n.replace(/[A-Z]/, l),
          ),
          'width' == n)
        )
  ...
  (function (e, t) {
    ...
    function n(e, t) {
      for (
        ...
        if (A.flags.dimensions.match(d))
          ...
          t.themes.hasOwnProperty(d) && (r.theme = p(t.themes[d], null)),
            (u = !0);
    ...
    function i(e, t, r, n) {
      ...
      if (
        ...
        null != r.text &&
          ((a.text = r.text), 'object' === t.nodeName.toLowerCase()))
      ) {
      ...
      r.font &&
        ...
        'background' == e
          ? null == t.getAttribute('data-background-src') &&
            c(t, { 'data-background-src': f })
          : c(t, { 'data-src': f }),
        (r.theme = a),
        ...
        ('image' == e || 'fluid' == e) &&
          c(t, {
            alt: a.text
              ? (a.text.length > 16 ? a.text.substring(0, 16) + '…' : a.text) +
                ' [' +
                l +
                ']'
              : l,
      ...
      'background' == e
        ...
        : ('img' === r.nodeName.toLowerCase()
            ...
            : 'object' === r.nodeName.toLowerCase() &&
              (c(r, { data: o }), c(r, { type: 'image/svg+xml' })),
          n.reRender &&
            setTimeout(function () {
              var e = i();
      ...
      switch (
        ((e.font = {
          ...
          size: l(
            e.width,
            e.height,
            e.theme.size ? e.theme.size : A.defaults.size,
          ),
      ...
      if (a.lineCount > 1) {
        ...
        for (var g = 0; g < a.words.length; g++) {
          ...
          (h + p.width >= c || m === !0) &&
            ...
            (d.y = u)),
            m !== !0 &&
              (s.moveTo(h, 0), (h += a.spaceWidth + p.width), d.add(s));
        }
        t(o, d, h, o.properties.leading);
        ...
        if (t.hasOwnProperty(r)) {
          ...
          if (n.holderData) {
            ...
            if (a) {
              ...
              i.textmode &&
                'exact' == i.textmode &&
                ((i.exactDimensions = a), (h.dimensions = i.dimensions)),
      ...
      if (e.holderData) {
        ...
        if (t) {
          ...
          n.fluidWidth && !n.fluidHeight
            ? ((n.mode = 'width'),
              (n.ratio =
                n.initialDimensions.width / parseFloat(r.dimensions.height)))
            : !n.fluidWidth &&
              n.fluidHeight &&
              ((n.mode = 'height'),
              (n.ratio =
                parseFloat(r.dimensions.width) / n.initialDimensions.height)),
      ...
      if (t.XMLSerializer) {
        ...
        if (r.svgXMLStylesheet) {
          for (
            ...
            var s = a.createProcessingInstruction(
              'xml-stylesheet',
              'href="' + o[l] + '" rel="stylesheet"',
            );
            a.insertBefore(s, a.firstChild);
          }
          var d = a.createProcessingInstruction(
            'xml',
    ...
    var C = 'http://www.w3.org/2000/svg',
      ...
      k = {
        addTheme: function (e, t) {
          return (
            null != e && null != t && (A.settings.themes[e] = t),
        ...
        run: function (e) {
          ...
          for (var c = 0; c < d.length; c++) {
            ...
            if (
              f.attributes.rel &&
              f.attributes.href &&
              'stylesheet' == f.attributes.rel.value
            ) {
      ...
      T = (function () {
        ...
        return function (n) {
          ...
          if (A.setup.supportsSVG) {
            ...
            var d = t.getBBox(),
              h = Math.ceil(
                d.width / (i.properties.width * A.setup.lineWrapRatio),
              ),
              g = s.text.split(' '),
              p = s.text.match(/\\n/g);
            (h += null == p ? 0 : p.length),
          ...
          return (
            ...
            function (t, n) {
              ...
              var k =
                ...
                btoa(unescape(encodeURIComponent(g(e, n))));
              return k;
            }
          );
        }
