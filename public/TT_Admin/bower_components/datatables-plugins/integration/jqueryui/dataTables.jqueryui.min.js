...
(function () {
  var b = function (a, c) {
    ...
    c.ext.renderer.header.jqueryui = function (c, g, e, d) {
      ...
      !e.bSortable || (!b && !h)
        ...
        : !b && h && (f = 'css_right ui-icon ui-icon-carat-1-s');
      a('<div/>')
        .addClass('DataTables_sort_wrapper')
        .append(g.contents())
        .append(a('<span/>').addClass(d.sSortIcon + ' ' + f))
        .appendTo(g);
  ...
  'function' === typeof define && define.amd
    ...
    : jQuery && b(jQuery, jQuery.fn.dataTable);
})(window, document);
