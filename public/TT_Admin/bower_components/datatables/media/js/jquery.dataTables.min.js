  ...
  var O = function (g) {
    ...
    function G(a, b, c) {
      ...
      g.each(b, function (d) {
        ...
        if (e !== l && (c || b[e] === l))
          'o' === e.charAt(0)
            ? (b[e] || (b[e] = {}), g.extend(!0, b[e], b[d]), G(a[e], b[e], c))
            : (b[e] = b[d]);
      });
    }
    function O(a) {
    ...
    function Ga(a) {
      ...
      for (f = b.length; d < f; d++)
        if (((m = b[d]), (k = []), !m.sType && m._sManualType))
            ...
            (h = n[i]),
              ...
              h && h._bAttrSrc
                ? (Q(h.mData._)(e, j),
                  ...
                  o(h.mData.filter, a))
                : m
                ? (h._setter || (h._setter = Q(h.mData)), h._setter(e, j))
                : (e[i] = j);
          i++;
        };
      if (f)
    ...
    function Ia(a, b, c, e) {
      ...
      if (null === d.nTr) {
        ...
        for (o = a.aoColumns.length; m < o; m++) {
          ...
          g.fnCreatedCell &&
            g.fnCreatedCell.call(a.oInstance, j, v(a, b, m), f, b, m);
        }
        ...
        for (d = h.length; e < d; e++) {
          ...
          for (b = h[e].length; f < b; f++)
            if (((n = j = 1), i[e][f] === l)) {
              ...
              for (
                i[e][f] = 1;
                h[e + j] !== l && h[e][f].cell == h[e + j][f].cell;
        ...
        if (0 !== j.length) {
          ...
          for (i = i ? 0 : h; i < f; i++) {
            ...
            if (0 !== d) {
              var k = e[c % d];
              o._sRowStripe != k &&
                (g(m).removeClass(o._sRowStripe).addClass(k),
                (o._sRowStripe = k));
            }
    ...
    function lb(a) {
      ...
      for (
        var f = a.sDom.split(''), h, i, j, n, m, o, k = 0;
        k < f.length;
        k++
      ) {
        h = null;
        ...
        h &&
          ((j = a.aanFeatures), j[i] || (j[i] = []), j[i].push(h), d.append(h));
      }
      c.replaceWith(d);
    }
    function da(a, b) {
    ...
    function ra(a, b) {
      var c =
        g.isPlainObject(a.ajax) && a.ajax.dataSrc !== l
          ? a.ajax.dataSrc
          : a.sAjaxDataProp;
      ...
      if ('ssp' != A(a)) {
        ...
        for (b = 0; b < d.length; b++)
          vb(
            ...
            d[b].sSearch,
            b,
            d[b].bEscapeRegex !== l ? !d[b].bEscapeRegex : d[b].bRegex,
            d[b].bSmart,
    ...
    function wb(a) {
      for (
        var b = p.ext.search, c = a.aiDisplay, e, d, f = 0, h = b.length;
        f < h;
        f++
      ) {
    ...
    function vb(a, b, c, e, d, f) {
      if ('' !== b)
        for (
          var h = a.aiDisplay, e = Pa(b, e, d, f), d = h.length - 1;
          0 <= d;
          d--
        )
        ...
        if (((n = a.aoData[e]), !n._aFilterData)) {
          ...
          for (h = b.length; d < h; d++)
            (c = b[d]),
              c.bSearchable
                ? ((g = v(a, e, d, 'filter')),
                  m[c.sType] && (g = m[c.sType](g)),
                  null === g && (g = ''),
                  'string' !== typeof g && g.toString && (g = g.toString()))
                : (g = ''),
              g.indexOf &&
                -1 !== g.indexOf('&') &&
                ((va.innerHTML = g), (g = Yb ? va.textContent : va.innerText)),
    ...
    function Y(a) {
      ...
      J &&
        ((K = J.clone().prependTo(q)), (v = J.find('tr')), (K = K.find('tr')));
      ...
      if ('' === c) {
        if (
          ((N.width = '100%'),
          w &&
            (q.find('tbody').height() > j.offsetHeight ||
        ...
        '' !== e
          ...
          ? ((N.width = s(h - f)), q.outerWidth() > h - f && (N.width = s(h)))
          : (N.width = s(h));
      h = q.outerWidth();
      F(E, x);
      F(function (a) {
      ...
      if (q.outerWidth() < h) {
        v =
          j.scrollHeight > j.offsetHeight || 'scroll' == o.css('overflow-y')
            ? h + f
            : h;
        if (
          w &&
      ...
      d &&
        b.bCollapse &&
        ((k.height = s(d)),
        (b = c && t.offsetWidth > j.offsetWidth ? f : 0),
        t.offsetHeight < j.offsetHeight && (k.height = s(t.offsetHeight + b)));
      b = q.outerWidth();
      m[0].style.width = s(b);
      n.width = s(b);
    ...
    function F(a, b, c) {
      for (var e = 0, d = 0, f = b.length, h, g; d < f; ) {
        ...
        for (g = c ? c[d].firstChild : null; h; )
          1 === h.nodeType && (c ? a(h, g, e) : a(h, e), e++),
            (h = h.nextSibling),
    ...
    function Fa(a) {
      ...
      if (!o && !f && !d && i == aa(a) && i == j.length)
        ...
        f && h
          ...
          : f
          ? (i.css('width', 'auto'),
            i.width() < m.offsetWidth && i.width(m.offsetWidth))
          : d
          ...
          for (k = h = 0; k < e.length; k++)
            (l = c[e[k]]),
              ...
              (h +=
                null === l.sWidthOrig
                  ? d
                  : parseInt(l.sWidth, 10) + d - g(j[k]).width());
          i.width(s(h));
          b.style.width = s(h);
        }
        for (k = 0; k < e.length; k++)
    ...
    function Hb(a, b) {
      ...
      for (
        var f,
          h = p.ext.type.order[c.sType + '-pre'],
          g = 0,
          j = a.aoData.length;
        g < j;
        g++
    ...
    function Jb(a) {
      ...
      if (a.oFeatures.bStateSave) {
        ...
        if (
          d &&
          d.time &&
          ((b = u(a, 'aoStateLoadParams', 'stateLoadParams', [a, d])),
          -1 === g.inArray(!1, b) &&
            ((b = a.iStateDuration),
    ...
    function Kb(a, b, c) {
      ...
      for (d in b)
        b.hasOwnProperty(d) &&
          ((e = b[d]),
          g.isPlainObject(e)
            ? (g.isPlainObject(a[d]) || (a[d] = {}), g.extend(!0, a[d], e))
            : (a[d] =
                c && 'data' !== d && 'aaData' !== d && g.isArray(e)
                  ? e.slice()
                  : e));
      return a;
    }
    ...
    function Mb(a) {
      return function () {
        var b = [ya(this[p.ext.iApiIndex])].concat(
    ...
    p = function (a) {
      ...
      this.each(function () {
        ...
        if ('table' != this.nodeName.toLowerCase())
          ...
          j = k.oClasses;
          d.bJQueryUI
            ? (g.extend(j, p.ext.oJUIClasses, d.oClasses),
              d.sDom === m.sDom &&
                'lfrtip' === m.sDom &&
                (k.sDom = '<"H"lfr>t<"F"ip>'),
              k.renderer)
          ...
          k.iInitDisplayStart === l &&
            ((k.iInitDisplayStart = d.iDisplayStart),
            (k._iDisplayStart = d.iDisplayStart));
          null !== d.iDeferLoading &&
            ((k.bDeferLoading = !0),
            (h = g.isArray(d.iDeferLoading)),
            (k._iRecordsDisplay = h ? d.iDeferLoading[0] : d.iDeferLoading),
            (k._iRecordsTotal = h ? d.iDeferLoading[1] : d.iDeferLoading));
          var r = k.oLanguage;
          ...
          null === d.asStripeClasses &&
            (k.asStripeClasses = [j.sStripeOdd, j.sStripeEven]);
          ...
          d.bStateSave &&
            ((v.bStateSave = !0),
            Jb(k, d),
            x(k, 'aoDrawCallback', xa, 'state_save'));
          if (d.aaSorting === l) {
            o = k.aaSorting;
            h = 0;
            for (i = o.length; h < i; h++)
      ...
      bc = function (a) {
        ...
        if (a) {
          ...
          if (a.nodeName && 'table' === a.nodeName.toLowerCase())
            return (b = g.inArray(a, d)), -1 !== b ? [e[b]] : null;
          ...
          if ('table' === b) (f = c.call(r, m[h], h)), f !== l && d.push(f);
            ...
            for (n = k.length; j < n; j++)
              (f = k[j]),
                (f =
                  'cell' === b
                    ? c.call(r, m[h], f.row, f.column, h, j)
                    : c.call(r, m[h], f, h, j, o)),
                f !== l && d.push(f);
          }
        }
        return d.length || e
          ? ((a = new q(m, a ? d.concat.apply([], d) : d)),
            (b = a.selector),
            (b.rows = p.rows),
            (b.cols = p.cols),
            (b.opts = p.opts),
    ...
    q.register = r = function (a, b) {
      if (g.isArray(a))
        ...
        for (
          var d = a.split('.'), f = Sb, h, i, c = 0, e = d.length;
          c < e;
          c++
        ) {
    ...
    var Za = function (a, b) {
        ...
        for (h = a.length; f < h; f++) {
          ...
          for (j = d.length; i < j; i++)
            (e = b('string' === typeof d[i] ? g.trim(d[i]) : d[i])) &&
              e.length &&
              c.push.apply(c, e);
        }
        return c;
    ...
    var bb = function (a, b) {
        var c = a.context;
        c.length &&
          ((c = c[0].aoData[b !== l ? b : a[0]]),
          c._details &&
            (c._details.remove(), (c._detailsShow = l), (c._details = l)));
      },
      Ub = function (a, b) {
        var c = a.context;
      ...
      header: {
        ...
        jqueryui: function (a, b, c, e) {
          g('<div/>')
            ...
            .append(b.contents())
            .append(
              g('<span/>').addClass(e.sSortIcon + ' ' + c.sSortingClassJUI),
            )
            .appendTo(b);
